...
var gplay = {
  ...
  tStat:{},
  camRad:200, camRadd:100, camThet:0, camPhi:Math.PI/6, spincam:0,
  keyY:0, keyX:0, keyZ:0, 
  paused:1, explode:0, 
  gravity:1, bgravity:0, cgravity:0.99,
  vtimef:0.2,
  velfz:0.15,
  pradius:0.04,
  slow:1,
...
gplay.gravity=gplay.cgravity*Fd.range(0,0.6)
}
...
function action() {
  ...
  if ((!gplay.paused)&&((gplay.scount++)%gplay.slow==0)){ 
    ...
    if (gplay.gravity){
      gplay.gravity=(gplay.gravity*50+gplay.cgravity)/51 
